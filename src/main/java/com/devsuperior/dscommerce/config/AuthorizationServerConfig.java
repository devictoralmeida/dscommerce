...
public class AuthorizationServerConfig {
  ...
  public SecurityFilterChain asSecurityFilterChain(HttpSecurity http) throws Exception {
    ...
    http.getConfigurer(OAuth2AuthorizationServerConfigurer.class)
            .tokenEndpoint(tokenEndpoint -> tokenEndpoint
                    ...
                    .authenticationProvider(new CustomPasswordAuthenticationProvider(this.authorizationService(), this.tokenGenerator(), this.userDetailsService, this.passwordEncoder())));
  ...
  public TokenSettings tokenSettings() {
    ...
    return TokenSettings.builder()
            ...
            .accessTokenTimeToLive(Duration.ofSeconds(this.jwtDurationSeconds))
            .build();
    // @formatter:on
  }
  ...
  public OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator() {
    ...
    jwtGenerator.setJwtCustomizer(this.tokenCustomizer());
